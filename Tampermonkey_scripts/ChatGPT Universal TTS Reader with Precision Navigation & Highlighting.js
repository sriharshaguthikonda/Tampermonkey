...
// driftwatch-stamp: chatgpt.com@2 dist-sha256=3df3d0c6ec560821
(function () {
  ...
  if (typeof module !== 'undefined' && module.exports) module.exports.packs = packs;
    ...
    const TTSReader = {
        ...
        cleanSmartCopyWorkingNode(node) {
            ...
            if (this.isChatGPTPage) selectors.push(...this.packData('smartCopyStripSelectors'));
            else selectors.push(LEGACY_DOM.COPY_TESTID, LEGACY_DOM.TURN_ACTION_TESTID);
        ...
        isInsideSkippedCodeContainer(element) {
            ...
            const speechSkipSelectors = this.packData('speechSkipSelectors');
        ...
        startReadingOnClick(event) {
            ...
            } else if (event.target.closest(LEGACY_DOM.THREAD_BOTTOM_CONTAINER)) {
                return;
            }
