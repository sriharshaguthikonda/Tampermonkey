// Vendored from C:/Windows_software/driftwatch (dist/driftwatch.js), built via `npm run build`.
// GENERATED FILE — do not hand-edit. Fix bugs upstream in driftwatch, then re-copy dist/driftwatch.js here.
(function () {
    ...
    "anchors": {
      ...
      "copyResponseButton": {
        ...
        "strategies": [
          ...
          {
            "id": "copy.aria-label-prefix",
            "css": "button[aria-label^=\"Copy\"]",
            "requires": [
              "inside:conversationTurn"
            ]
          }
        ]
      },
      "composer": {
        ...
        "strategies": [
          {
            "id": "composer.prompt-textarea-contenteditable",
            "css": "div#prompt-textarea[contenteditable=\"true\"]"
          },
          {
            "id": "composer.contenteditable-textbox",
            "css": "[contenteditable=\"true\"][role=\"textbox\"]"
          },
          {
            "id": "composer.prompt-textarea-id",
            "css": "#prompt-textarea"
          }
        ]
      },
      "sendButton": {
        ...
        "strategies": [
          ...
          {
            "id": "send.aria-label-prefix",
            "css": "form button[aria-label^=\"Send\"]:not([disabled])",
            "requires": [
              "connected",
              "enabled"
            ]
